...
var Media = function(inputFile, inputFormat, inputOptions, fileSize){
  ...
  this.inputOptions = (inputOptions === null || _.isEmpty(inputOptions)) ? {"y" : true, "stats" : true} : inputOptions;
...
Media.prototype.transcode = function(cb){
  ...
  var inputFiles = {};
  inputFiles[this.inputFile] = convertOptions({}, inputVideo);

  avconv(inputFiles, outputFiles, convertOptions(this.inputOptions, inputVideo), function(err, finished, status){
    if(finished){
